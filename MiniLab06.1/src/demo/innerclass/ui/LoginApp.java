...
public class LoginApp
    ...
    public LoginApp() {
        ...
        // NOTE: the listener object lives "in here" so it has access to the private fields!
        // (like a house, the InnerListener is the "basement" but still same house
...
// NAMED MEMBER-LEVEL INNER CLASSES (almost always private)
