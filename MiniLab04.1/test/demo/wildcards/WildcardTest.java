...
public class WildcardTest {
    ...
    public void testSumDouble() {
        Collection<Double> doubles = new ArrayList<>(); // not a subclass, just another collection
        doubles.add(3.14);
        doubles.add(2.78);
     ...
     */
    private double sum(Collection<? extends Number> values) { // a collection of anything as long as it includes (IS-A) number
        double sum = 0.0;
