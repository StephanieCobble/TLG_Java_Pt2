...
//        MusicItem result = null;
    ...
    public Collection<MusicItem> findByCategory(MusicCategory category) {
        // declare return value, in this case, as empty result collection
        Collection<MusicItem> result = new ArrayList<>();
...
//        // items.price <= 15.0?
//        for (MusicItem item : catalogData) {
//            double price = item.setPrice([1.0, 15.0]);
//            if (item.getMusicCategory().equals(MusicCategory.ROCK) && item.getPrice().equals(price <= 15.00)) {
//                result.add(item);
//            }
//        }
//
